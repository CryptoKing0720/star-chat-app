...
export default function Home() {
  ...
  function connectToScaledrone() {
    drone = new window.Scaledrone("OGwAHUaEgh18Npf8", {
      data: meRef.current,
    });
    ...
    const room = drone.subscribe("observable-glitter-star");
    ...
    room.on("message", (message) => {
      ...
      } else setMessages([...messagesRef.current, message]);
    });
